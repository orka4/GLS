...
First, we shall remove NA values from the 'Solar.R' vector in the airquality dataset, and make sure the vector is a numeric vector.
  ...
  ```r
  airdata <- airdata[!is.na(airdata$Solar.R), ] #Remove NA values
  ...
  ```r
  data3_1<- airdata[-111,] #dataframe containing rows 1- n-1

  data3_2<-airdata[-1,] #dataframe containing rows 2-n
  ```
  ...
  ```r
  acf(airdata$Solar.R, lag.max=31)
  pacf(airdata$Solar.R, lag.max=31)
  ```
